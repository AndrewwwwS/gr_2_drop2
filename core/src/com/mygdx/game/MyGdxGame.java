...
public class MyGdxGame extends ApplicationAdapter {
    ...
    public void render() {
        ...
        // создаем цикл для интерировани\ капель, т.е будем отслеживать каждую созданную каплю и заставлять её падать вниз, в случае падения в ведро или за пределы экрана мы будем эту каплю удалять и при попадании в ведро проигрывать звук
